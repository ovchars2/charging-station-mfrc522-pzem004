...
class ConnectorV16(ChargingConnector):
    ...
    def __init__(self, evse_id: int, connector_id: int, conn_type: str, relay_pin: int, relay_state,
                 power_meter_port: str, power_meter_min_power: float,
                 max_charging_time: int, stop_transaction_function,
                 send_meter_values_function):
        super().__init__(evse_id, connector_id, conn_type, relay_pin, relay_state, power_meter_port,
                         power_meter_min_power, max_charging_time, stop_transaction_function,
                         send_meter_values_function)
