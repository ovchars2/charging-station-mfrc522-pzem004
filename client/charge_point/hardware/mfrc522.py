...
class MFRC522:
    ...
    def MFRC522_Request(self, reqMode):
        ...
        # Записати 0х07 у регістр BitFraming для налаштування формату передачі даних
        self.Write_MFRC522(self.BitFramingReg, 0x07)

        # Додати тип запиту - всі дані або лише UID картки
        TagType.append(reqMode);
        # Спробувати конвертувати отримані дані у формат даних картки
        (status,backData,backBits) = self.MFRC522_ToCard(self.PCD_TRANSCEIVE, TagType)

        # Встановити статус помилки, якщо зчитування не вдалось
